                                ...
                                <tr>
                                    <td class="content" style="padding: 40px; text-align: {{ app()->getLocale() === 'ar' ? 'right' : 'left' }}; font-family: Arial, sans-serif;">
                                        ...
                                        <p style="margin: 0 0 20px 0; color: #4a5568; font-size: 16px; line-height: 1.6;">
                                            @if(app()->getLocale() === 'ar')
                                                مرحباً <strong>{{ $notifiable->name }}</strong>،
                                            @else
                                                Hello <strong>{{ $notifiable->name }}</strong>,
                                            @endif
                                        </p>
                                        
                                        <div style="margin: 0 0 24px 0; color: #4a5568; font-size: 16px; line-height: 1.6;">
                                            @yield('content')
                                        </div>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td align="center" bgcolor="#667eea" style="background-color: #667eea;">
                                                                <a href="@yield('action_url')" target="_blank" style="display: inline-block; padding: 16px 36px; color: #ffffff; text-decoration: none; font-weight: bold; font-size: 16px; border: 1px solid #667eea;">
                                                                    @yield('action_text')
                                                                </a>
                                                            </td>
                                                        </tr>
                                        ...
                                        <p style="margin: 30px 0 0 0; color: #718096; font-size: 14px; line-height: 1.5; text-align: center; border-top: 1px solid #edf2f7; padding-top: 20px;">
                                            {{ __('notifications.thank_you') }}
                                        </p>
                    ...
                    <tr>
                        <td style="padding: 30px 20px; text-align: center; font-family: Arial, sans-serif;">
                            ...
                            <p style="margin: 0; color: #cbd5e0; font-size: 11px;">
                                @if(app()->getLocale() === 'ar')
                                    تلقيت هذا البريد لأنك مسجل في منصتنا.
                                @else
                                    You are receiving this email because you are registered on our platform.
                                @endif
                            </p>
                        </td>
                    </tr>
