                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-lg-12">
                        <div class="border rounded-3 p-3 h-100 bg-light">
                            ...
                            <div class="row g-2">
                                @forelse(array_slice($idea->resources->first()->translated_requirements ?? [], 0, 6) as $index => $resource)
                                    <div class="col-md-6">
                    ...
                    <div class="col-lg-4">
                        <div class="border rounded-3 p-3 h-100 bg-light">
                            ...
                            <div class="small text-dark">
                                @if (optional($idea->expenses->first())->capital_distribution)
                                    @foreach (optional($idea->expenses->first())->capital_distribution as $expense)
                                        <span>{{ $expense }}</span>
                                        @if (!$loop->last)
                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-3">
                        <div class="border rounded-3 p-3 h-100 bg-light">
                            ...
                            @if($idea->id && $idea->attachments->count() > 0)
                                ...
                                @endforeach
                            @elseif($state['step9']['data']['attachment'])
                                <div class="d-flex align-items-center gap-2 mb-2 p-2 bg-white rounded-2">
                                    <i class="bi bi-file-earmark-pdf text-danger"></i>
                                    <div class="flex-grow-1" style="min-width: 0;">
                                        <div class="text-truncate small fw-semibold">
                                            {{ $state['step9']['data']['attachment']->getClientOriginalName() }}
                                        </div>
                                    </div>
                                </div>
                            @elseif($state['step9']['currentAttachment'] !== 'Uploaded File')
                                <div class="d-flex align-items-center gap-2 mb-2 p-2 bg-white rounded-2">
                                    <i class="bi bi-file-earmark-pdf text-danger"></i>
                                    <div class="flex-grow-1" style="min-width: 0;">
                                        <div class="text-truncate small fw-semibold">
                                            {{ $state['step9']['currentAttachment'] }}
                                        </div>
                                    </div>
                                </div>
                            @else
