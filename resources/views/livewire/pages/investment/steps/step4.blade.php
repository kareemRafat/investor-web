<div x-data="{
    contribute_type: @entangle('state.step4.data.contribute_type'),
    staff: @entangle('state.step4.data.staff'),
    staff_person_money: @entangle('state.step4.data.staff_person_money'),
    money_amount: @entangle('state.step4.data.money_amount'),
    money_percent: @entangle('state.step4.data.money_percent'),
    person_money_amount: @entangle('state.step4.data.person_money_amount'),
    person_money_percent: @entangle('state.step4.data.person_money_percent'),
        ...
        <div class="row g-3">
                ...
                <div class="requirement-row">
                    <div class="row g-2 align-items-center">
                        <div class="col-12 col-lg-7">
                            <input type="radio" class="btn-check" id="needs" wire:model="state.step4.data.contribute_type"
            ...
            <div class="col-12">
                <div class="requirement-row">
                    <div class="row g-2 align-items-center">
                        <div class="col-12 col-lg-7">
                            <input type="radio" class="btn-check" id="contribute" wire:model="state.step4.data.contribute_type"
                    ...
                    <div class="row g-3 align-items-center">
                        <div class="col-12 col-lg-7">
                            <input type="radio" class="btn-check" id="contribute_person"
                                wire:model="state.step4.data.contribute_type" x-model="contribute_type"
                            ...
                            <div class="options-section">
                                <div class="option-item">
                                    <input type="radio" class="form-check-input m-0" id="staff_yes"
                                        wire:model="state.step4.data.staff" x-model="staff" value="full_time" name="staff">
                                ...
                                <div class="option-item">
                                    <input type="radio" class="form-check-input m-0" id="staff_no"
                                        wire:model="state.step4.data.staff" x-model="staff" value="part_time" name="staff">
                                ...
                                <div class="option-item">
                                    <input type="radio" class="form-check-input m-0" id="admin_only_no"
                                        wire:model="state.step4.data.staff" x-model="staff" value="supervision" name="staff">
                            ...
                            <div
                                ...
                                <div class="number-input-wrapper">
                                    ...
                                    <input type="number" class="number-input" id="money_amount"
                                        wire:model="state.step4.data.money_amount" x-model="money_amount" name="money_amount"
                                        placeholder="$" />
                                </div>
                                <div class="number-input-wrapper">
                                    ...
                                    <input type="number" class="number-input w-100" id="money_percent"
                                        wire:model="state.step4.data.money_percent" x-model="money_percent" name="money_percent"
                                        placeholder="%" />
                                </div>
                            </div>
                        </div>
                                ...
                                <div
                                    ...
                                    <div class="number-input-wrapper">
                                        ...
                                        <input type="number" class="number-input" id="person_money_amount"
                                            wire:model="state.step4.data.person_money_amount" x-model="person_money_amount"
                                    ...
                                    <div class="number-input-wrapper">
                                        ...
                                        <input type="number" class="number-input w-100" id="person_money_percent"
                                            wire:model="state.step4.data.person_money_percent" x-model="person_money_percent"
                                ...
                                <div class="options-section">
                                    <div class="option-item">
                                        <input type="radio" class="form-check-input m-0"
                                            id="staff_yes_person_money" wire:model="state.step4.data.staff_person_money"
                                    ...
                                    <div class="option-item">
                                        <input type="radio" class="form-check-input m-0" id="staff_no_person_money"
                                            wire:model="state.step4.data.staff_person_money" x-model="staff_person_money"
                                    ...
                                    <div class="option-item">
                                        <input type="radio" class="form-check-input m-0"
                                            id="admin_only_no_person_money" wire:model="state.step4.data.staff_person_money"
