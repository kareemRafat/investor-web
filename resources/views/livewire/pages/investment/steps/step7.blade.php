                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-3">
                            <div class="border rounded-3 p-3 h-100 bg-light">
                                ...
                                @if($investor->id && $investor->attachments->count() > 0)
                                    @foreach($investor->attachments as $file)
                                    ...
                                    @endforeach
                                @elseif($state['step6']['data']['attachment'])
                                    <div class="d-flex align-items-center gap-2 mb-2 p-2 bg-white rounded-2">
                                        <i class="bi bi-file-earmark-pdf text-danger"></i>
                                        <div class="flex-grow-1" style="min-width: 0;">
                                            <div class="text-truncate small fw-semibold">
                                                {{ $state['step6']['data']['attachment']->getClientOriginalName() }}
                                            </div>
                                        </div>
                                    </div>
                                @elseif($state['step6']['currentAttachment'] !== 'Uploaded File')
                                    <div class="d-flex align-items-center gap-2 mb-2 p-2 bg-white rounded-2">
                                        <i class="bi bi-file-earmark-pdf text-danger"></i>
                                        <div class="flex-grow-1" style="min-width: 0;">
                                            <div class="text-truncate small fw-semibold">
                                                {{ $state['step6']['currentAttachment'] }}
                                            </div>
                                        </div>
                                    </div>
                                @else
