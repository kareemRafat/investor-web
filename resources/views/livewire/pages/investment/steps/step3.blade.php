<div>
    ...
    <div class="step_height bg-white rounded-4 shadow-lg p-3 p-md-4">
        ...
        <div class="d-flex align-items-center gap-3 mb-4 p-2 rounded-3" style="background: #f5f2fe; border: 2px solid #afa5fc;">
            <input type="checkbox" id="disable_resources" wire:model.live="state.step3.disableResources"
                            ...
                            <div class="d-flex gap-2 align-items-center question-section">
                                ...
                                <div class="yn-buttons-wrapper">
                                    <input type="radio" class="btn-check" id="company_yes"
                                        wire:model="state.step3.data.company" value="yes" name="company" @disabled($state['step3']['disableResources'])>
                                    <label class="yn-button" for="company_yes">
                                        {{ __('investor.common.yes') }}
                                    </label>

                                    <input type="radio" class="btn-check" id="company_no"
                                        wire:model="state.step3.data.company" value="no" name="company" @disabled($state['step3']['disableResources'])>
                            ...
                            <div class="options-section">
                                ...
                                <div class="option-item">
                                    <input class="form-check-input m-0" type="radio" name="space_type"
                                        id="space_type_large" wire:model="state.step3.data.space_type" value="large" @disabled($state['step3']['disableResources'])>
                                ...
                                <div class="option-item">
                                    <input class="form-check-input m-0" type="radio" name="space_type"
                                        id="space_type_small" wire:model="state.step3.data.space_type" value="small" @disabled($state['step3']['disableResources'])>
                            ...
                            <div class="d-flex gap-2 align-items-center question-section">
                                ...
                                <div class="yn-buttons-wrapper">
                                    <input type="radio" class="btn-check" id="staff_yes"
                                        wire:model="state.step3.data.staff" value="yes" name="staff" @disabled($state['step3']['disableResources'])>
                                    <label class="yn-button" for="staff_yes">
                                        {{ __('investor.common.yes') }}
                                    </label>

                                    <input type="radio" class="btn-check" id="staff_no"
                                        wire:model="state.step3.data.staff" value="no" name="staff" @disabled($state['step3']['disableResources'])>
                        ...
                        <div class="col-12 col-lg-5">
                            <div class="number-input-wrapper">
                                ...
                                <input type="number" class="number-input" id="staff_number"
                                    wire:model="state.step3.data.staff_number"
                            ...
                            <div class="d-flex gap-2 align-items-center question-section">
                                ...
                                <div class="yn-buttons-wrapper">
                                    <input type="radio" class="btn-check" id="workers_yes"
                                        wire:model="state.step3.data.workers" value="yes" name="workers" @disabled($state['step3']['disableResources'])>
                                    <label class="yn-button" for="workers_yes">
                                        {{ __('investor.common.yes') }}
                                    </label>

                                    <input type="radio" class="btn-check" id="workers_no"
                                        wire:model="state.step3.data.workers" value="no" name="workers" @disabled($state['step3']['disableResources'])>
                        ...
                        <div class="col-12 col-lg-5">
                            <div class="number-input-wrapper">
                                ...
                                <input type="number" class="number-input" id="workers_number"
                                    wire:model="state.step3.data.workers_number"
                                    placeholder="{{ __('investor.common.enter_number') }}" @disabled($state['step3']['disableResources'])/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 align-items-center">
                            ...
                            <div class="d-flex gap-2 align-items-center question-section">
                                ...
                                <div class="yn-buttons-wrapper">
                                    <input type="radio" class="btn-check" id="spaces_yes"
                                        wire:model="state.step3.data.executive_spaces" value="yes" name="executive_spaces" @disabled($state['step3']['disableResources'])>
                                    <label class="yn-button" for="spaces_yes">
                                        {{ __('investor.common.yes') }}
                                    </label>

                                    <input type="radio" class="btn-check" id="spaces_no"
                                        wire:model="state.step3.data.executive_spaces" value="no" name="executive_spaces" @disabled($state['step3']['disableResources'])>
                        ...
                        <div class="col-12 col-lg-5">
                            <div class="options-section">
                                ...
                                <div class="option-item">
                                    <input class="form-check-input m-0" type="radio" name="executive_spaces_type"
                                        id="factory_type" wire:model="state.step3.data.executive_spaces_type" value="factory" @disabled($state['step3']['disableResources'])>
                                ...
                                <div class="option-item">
                                    <input class="form-check-input m-0" type="radio" name="executive_spaces_type"
                                        id="land_type" wire:model="state.step3.data.executive_spaces_type" value="land_space" @disabled($state['step3']['disableResources'])>
                            ...
                            <div class="d-flex gap-2 align-items-center question-section">
                                ...
                                <div class="yn-buttons-wrapper">
                                    <input type="radio" class="btn-check" id="equipment_yes"
                                        wire:model="state.step3.data.equipment" value="yes" name="equipment" @disabled($state['step3']['disableResources'])>
                                    <label class="yn-button" for="equipment_yes">
                                        {{ __('investor.common.yes') }}
                                    </label>

                                    <input type="radio" class="btn-check" id="equipment_no"
                                        wire:model="state.step3.data.equipment" value="no" name="equipment" @disabled($state['step3']['disableResources'])>
                            ...
                            <div class="options-section">
                                ...
                                <div class="option-item">
                                    <input type="radio" class="form-check-input m-0" id="Electronic"
                                        wire:model="state.step3.data.equipment_type" value="electronic" name="equipment_type" @disabled($state['step3']['disableResources'])>
                                ...
                                <div class="option-item">
                                    <input type="radio" class="form-check-input m-0" id="other_equipment"
                                        wire:model="state.step3.data.equipment_type" value="other" name="equipment_type" @disabled($state['step3']['disableResources'])>
                            ...
                            <div class="d-flex gap-2 align-items-center question-section">
                                ...
                                <div class="yn-buttons-wrapper">
                                    <input type="radio" class="btn-check" id="software_yes"
                                        wire:model="state.step3.data.software" value="yes" name="software" @disabled($state['step3']['disableResources'])>
                                    <label class="yn-button" for="software_yes">
                                        {{ __('investor.common.yes') }}
                                    </label>

                                    <input type="radio" class="btn-check" id="software_no"
                                        wire:model="state.step3.data.software" value="no" name="software" @disabled($state['step3']['disableResources'])>
                            ...
                            <div class="options-section">
                                ...
                                <div class="option-item">
                                    <input type="radio" class="form-check-input m-0" id="dynamic"
                                        wire:model="state.step3.data.software_type" value="dynamic" name="software_type" @disabled($state['step3']['disableResources'])>
                            ...
                            <div class="d-flex gap-2 align-items-center question-section">
                                ...
                                <div class="yn-buttons-wrapper">
                                    <input type="radio" class="btn-check" id="website_yes"
                                        wire:model="state.step3.data.website" value="yes" name="website" @disabled($state['step3']['disableResources'])>
                                    <label class="yn-button" for="website_yes">
                                        {{ __('investor.common.yes') }}
                                    </label>

                                    <input type="radio" class="btn-check" id="website_no"
                                        wire:model="state.step3.data.website" value="no" name="website" @disabled($state['step3']['disableResources'])>
