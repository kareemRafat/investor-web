                        ...
                        <div class="col-lg-6">
                            <div class="border rounded-3 p-3 h-100 bg-info bg-opacity-10">
                                <div class="d-flex align-items-center gap-2 mb-2">
                                    ...
                                    <small class="text-muted fw-semibold">{{ __('investor.steps.step7.best_countries') }}</small>
                                </div>
                                <div class="fw-semibold text-dark small">
                                    @forelse($investor->countries as $country)
                                        @php
                                            $countryOption = collect(__('investor.steps.step2.options'))->firstWhere('code', $country->country);
                        ...
                        <div class="col-lg-8">
                            <div class="border rounded-3 p-3 h-100 bg-light">
                                ...
                                <div class="row g-2">
                                    ...
                                    @empty
                                        <div class="col-12 text-center text-muted">{{ __('investor.common.unspecified') }}</div>
                                    @endforelse
                                </div>
                            </div>
                        </div>
