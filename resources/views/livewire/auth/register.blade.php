    ...
    <div class="split-container" x-data="{ loading: false }">
        <div class="form-side">
            <div class="form-container register-container">
                <form method="POST"
                    action="{{ LaravelLocalization::getLocalizedURL(app()->getLocale(), route('register.store')) }}"
                    ...
                    <div class="register-grid mt-2">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" name="name" class="form-control @error('name') error @enderror"
                                value="{{ old('name') }}" placeholder="{{ __('pages.register.name') }}">
                            @error('name')
                        ...
                        <div class="mb-2">
                            ...
                            <input type="email" name="email" class="form-control @error('email') error @enderror"
                                value="{{ old('email') }}" placeholder="{{ __('pages.register.email') }}">
                            @error('email')
                                <div class="error-message">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-2">
                            ...
                            <input type="tel" name="phone" class="form-control @error('phone') error @enderror"
                                value="{{ old('phone') }}" placeholder="{{ __('pages.register.phone') }}">
                            @error('phone')
                                <div class="error-message">
                                    {{ $message }}
                                </div>
                        ...
                        <!-- Residence Country -->
                        <div class="mb-2">
                            <label class="form-label">{{ __('pages.register.residence_country') }}</label>
                        ...
                        <!-- Job Title -->
                        <div class="mb-2">
                            <label class="form-label">{{ __('pages.register.job_title') }}</label>
                            <input type="text" name="job_title"
                                class="form-control @error('job_title') error @enderror" value="{{ old('job_title') }}"
                        ...
                        <!-- Birth Date -->
                        <div class="mb-2">
                            <label class="form-label">{{ __('pages.register.birth_date') }}</label>
        ...
        <div class="brand-side d-none d-lg-flex">
            ...
            <div class="glass-card">
                ...
                <svg class="graph-line" viewBox="0 0 100 25" preserveAspectRatio="none">
                    <path d="M0,25 Q20,10 40,18 T100,5" stroke="rgba(255,255,255,0.8)" fill="none"
