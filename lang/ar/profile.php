...
return [
    'title' => 'ملفي الشخصي',
    'welcome_message' => 'أهلاً بك! يرجى استكمال البيانات المتبقية في ملفك الشخصي.',

    'completion_title' => 'استكمال بيانات الملف الشخصي',
    ...
    'subscription' => [
        ...
        'next_reset' => 'تاريخ تجديد الرصيد القادم',
        'next_renewal' => 'تاريخ تجديد الباقة القادم',
        'na' => 'غير متوفر',
    ],

    'incomplete_profile' => [
        'title' => 'أكمل ملفك الشخصي',
        'message' => 'يرجى إكمال بيانات المسمى الوظيفي، الهاتف، وبلد الإقامة للاستفادة من كافة المميزات.',
        'cta' => 'تحديث البيانات',
    ],
];
